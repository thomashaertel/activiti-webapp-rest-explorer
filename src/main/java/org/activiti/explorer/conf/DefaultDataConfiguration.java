...
/**
 * @author Thomas Haertel
 */
@Configuration
public class DefaultDataConfiguration {
  
  protected static final Logger LOGGER = LoggerFactory.getLogger(DefaultDataConfiguration.class);
  ...
  @PostConstruct
  public void init() {
    if (Boolean.valueOf(environment.getProperty("create.default.users", "true"))) {
      LOGGER.info("Initializing default groups");
      initDemoGroups();
  ...
  protected void initDemoGroups() {
    String[] assignmentGroups = new String[] {"management", "department", "it"};
  ...
  protected void initDemoUsers() {
    createUser("admin", "System", "Administrator", "admin", "admin@localhost", 
            null,
            Arrays.asList("management", "department", "it", "user", "admin"),
            null);
  }
